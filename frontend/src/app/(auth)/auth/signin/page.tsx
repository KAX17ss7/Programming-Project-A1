      ...
      <div className="relative w-full max-w-md rounded-2xl border-2 border-dashed border-zinc-300 bg-white p-8 dark:bg-zinc-900 dark:border-zinc-700">
        ...
        <div className="mt-8 space-y-6">
          <div className="space-y-1 text-center">
            <h1 className="mx-auto w-full rounded-full text-zinc-900 bg-zinc-200 px-6 py-2 text-lg font-semibold">Log into your account</h1>
            <p className="text-sm text-zinc-500">Welcome back! Please sign in to continue</p>
          </div>

            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              <div className="space-y-1.5">
                <label htmlFor="email" className="text-sm font-bold pl-5">
                  Email address
                </label>
            ...
            <div className="space-y-1.5">
              <div className="flex items-center justify-between">
                <label htmlFor="password" className="text-sm font-bold pl-5 -mb-1">
                  Password
                </label>
              </div>
              ...
              <div className="text-right">
                <Link href="/auth/forgot" className="text-[13px] font-bold text-zinc-700 hover:text-zinc-900 underline dark:text-zinc-300 dark:hover:text-zinc-200">
                  Forgot password?
                </Link>
              </div>
            </div>
          ...
          <p className="text-center text-sm text-zinc-500">
            ...
            <Link href="/auth/signup" className="text-sm font-bold text-zinc-700 hover:text-zinc-900 underline dark:text-zinc-300 dark:hover:text-zinc-200">
              Sign up
            </Link>
          </p>
        </div>
